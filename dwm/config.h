...
static const char *fonts[]          = { "Ubuntu Mono:style=Regular:size=14:antialias=true:autohint=true", "FontAwesome:style=Regular:size=12:antialias=true:autohint=true", "Noto Color Emoji:style=Regular:pixelsize18:antialias=true:autohint=true" };
...
static const char col_cyan[]        = "#50C878"; 
